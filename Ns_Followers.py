...
class Ns_Followers:
    def __init__(self):
        ...
        self.__userid='66771716960' #Enter UserID Here
        self.__username='hisdadtop' #Enter UserName Here
        self._session='66771716960%3AuJdMWNifMkc0EO%3A7%3AAYczl1k-R9RZJlkNBteSxZSElbT2KdPzGBRY8T3QXA' #Enter SessionID Here
